#!/usr/bin/env bash
#-------------------------------------------------------------------------
# Arch Hodag Install Script, Based in Chris Titus's very excellent
# ArchTitus script. I have forked his project and tweaked it to meet
# my personal needs.
#-------------------------------------------------------------------------
...
#Enable ChaoticAUR for initial install
